...
Output: All significant off-target hits to rRNA db.
"""
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python3 target_specificity_trim_rRNA.py {input_file} {output_file}")
        sys.exit(1)

    input_file = sys.argv[1]
    output_file = sys.argv[2]

    trim_specificity(input_file, output_file)